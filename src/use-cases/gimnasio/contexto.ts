      ...
      if (!gym || !config) {
        if (isDevMockAuthEnabled()) {
          ...
          return ok({
            ...
            planes: [
              { id: "1", nombre: "2 días", diasSemana: 2, acceso: "DIAS_FIJOS", precio: null, activo: true },
              { id: "2", nombre: "3 días", diasSemana: 3, acceso: "DIAS_FIJOS", precio: null, activo: true },
              { id: "3", nombre: "4 días", diasSemana: 4, acceso: "DIAS_FIJOS", precio: null, activo: true },
              { id: "4", nombre: "5 días", diasSemana: 5, acceso: "DIAS_FIJOS", precio: null, activo: true },
